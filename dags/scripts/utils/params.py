...
class MATSim(BaseParams):
    def __init__(self):
        super().__init__()

        self.MATSim_selection_image = Param(
            "matsim:15.0-2022w40",
            type="string",
        ...
        self.MATSim_datapath_config = Param(
            type="string",
        ...
        self.MATSim_datapath_inputNetworkFile = Param(
            type="string",
        ...
        self.MATSim_datapath_inputPlansFile = Param(
            type="string",
        ...
        self.MATSim_datapath_inputCountsFile = Param(
            type=["string"],
        ...
        self.MATSim_datapath_vehiclesFile = Param(
            type=["null", "string"],
            title="[MATSim] transit vehiclesFile path"
        )
        self.MATSim_datapath_inputChangeEventsFile = Param(
            type=["null", "string"],
            title="[MATSim] inputChangeEventsFile path"
        )
        self.MATSim_datapath_transitScheduleFile = Param(
            type=["null", "string"],
            title="[MATSim] transitScheduleFile path"
        )
        self.MATSim_datapath_transitLinesAttributesFile = Param(
            type=["null", "string"],
            title="[MATSim] transitLinesAttributesFile"
        )
        self.MATSim_datapath_transitStopsAttributesFile = Param(
            type=["null", "string"],
            title="[MATSim] transitStopsAttributesFile"
        )
        self.MATSim_datapath_laneDefinitionsFile = Param(
            type=["null", "string"],
            title="[MATSim] laneDefinitionsFile"
        )
        self.MATSim_datapath_inputPersonAttributesFile = Param(
            type=["null", "string"],
            title="[MATSim] inputPersonAttributesFile"
        )
        self.MATSim_datapath_inputAlightCountsFile = Param(
            type=["null", "string"],
            title="[MATSim] inputAlightCountsFile"
        )
        self.MATSim_datapath_inputBoardCountsFile = Param(
            type=["null", "string"],
            title="[MATSim] inputBoardCountsFile"
        )
        self.MATSim_datapath_inputOccupancyCountsFile = Param(
            type=["null", "string"],
            title="[MATSim] inputOccupancyCountsFile"
        )

class FloodEvent(BaseParams):
    def __init__(self):
        super().__init__()

        self.floodEvent_datadir_flood_rasters = Param(
            type="string",
        ...
        self.floodEvent_datapath_network = Param(
            type="string",
        ...
        self.floodEvent_datavalue_crs = Param(
            "27700",
            type="string",
            title="[floodEvent] CRS"
        )
        self.floodEvent_datavalue_network_from = Param(
            "PT2",
            type="string",
            title="[floodEvent] network_from"
        )
        self.floodEvent_datavalue_network_buffer_factor = Param(
            1.825,
            type="number",
            title="[floodEvent] network_buffer_factor"
        )
        self.floodEvent_datavalue_excluded_modes = Param(
            type=["null", "array"],
...
class UdmSetup(BaseParams):
    def __init__(self):
        super().__init__()

        self.udmsetup_selection_image = Param(
        ...
        self.udmsetup_datapath_developed_coverage = Param(
            type="string",
            title="[udm-setup] developed_coverage path",
        )
        self.udmsetup_datapath_metadata = Param(
            type="string",
            title="[udm-setup] metadata path",
        )
        self.udmsetup_datapath_population = Param(
            type="string",
            title="[udm-setup] population path",
        )
        self.udmsetup_datapath_roads_proximity = Param(
            type="string",
            title="[udm-setup] roads_proximity path",
        )
        self.udmsetup_datapath_zone_identity = Param(
            type="string",
            title="[udm-setup] zone_identity path",
        )
        self.udmsetup_datavalue_attractors = Param(
            type="string",
        ...
        self.udmsetup_datavalue_constraints = Param(
            type="string",
        ...
        self.udmsetup_datavalue_current_development = Param(
            type="string",
        ...
        self.udmsetup_datavalue_density_from_raster = Param(
            type="integer",
        ...
        self.udmsetup_datavalue_people_per_dwelling = Param(
            type="number",
        ...
        self.udmsetup_datavalue_coverage_threshold = Param(
            type="number",
        ...
        self.udmsetup_datavalue_minimum_development_area = Param(
            type="integer",
        ...
        self.udmsetup_datavalue_maximum_plot_size = Param(
            type="integer",
        ...
        self.udmsetup_datavalue_extra_parameters = Param(
            type=["null", "string"],
...
class OpenUdm(BaseParams):
    def __init__(self):
        super().__init__()

        self.OpenUDM_selection_image = Param(
        ...
        self.OpenUDM_datapath_development_proximity_100m = Param(
            type="string",
...
class CityCat(BaseParams):
    def __init__(self):
        super().__init__()

        self.CityCAT_selection_image = Param(
            "citycat:6.4.16.8604",
            type="string",
        ...
        self.CityCAT_datapath_CityCat_Config_1 = Param(
            type="string",
        ...
        self.CityCAT_datapath_Rainfall_Data_1 = Param(
            type="string",
            title="[CityCAT] Rainfall_Data path",
            description="Your CityCat_Config and Rainfall_Data filenames will be renamed to CityCat_Config_1 and Rainfall_Data_1, with output name R1C1_SurfaceMaps"
        )
        self.CityCAT_datapath_Buildings = Param(
            type="string",
            title="[CityCAT] Buildings path",
        )
        self.CityCAT_datapath_Domain_DEM = Param(
            type="string",
            title="[CityCAT] Domain_DEM path",
        )
        self.CityCAT_datapath_GreenAreas = Param(
            type="string",
